...
function GameLevel2({username}) {
  ...
  const handleCountdownEnd = () => {
    ...
    let initialShapes = [
        ...
        { id: 3, type: "rectangle", color: "#3d85c6", size: "small", width: 60, height: 30 },
        { id: 4, type: "rectangle", color: "#3d85c6", size: "large", targetWidth: 120, targetHeight: 60 },
        { id: 5, type: "triangle", color: "#FFA726", size: "small", x: 350, y: 350, width: 60, height: 60 },
        { id: 6, type: "triangle", color: "#FFA726", size: "large", targetX: 750, targetY: 450, targetWidth: 120, targetHeight: 120 },
        { id: 7, type: "pentagon", color: "#A8C9A5", size: "small", width: 60, height: 60 },
        { id: 8, type: "pentagon", color: "#A8C9A5", size: "large", targetWidth: 120, targetHeight: 120 },
    ];
              ...
              .then(response => {
                ...
                getPrediction(userData.level + 1)
                  .then(predictionResponse => {
                    ...
                    saveLevelData(username, 2, timeTaken / correctMatches, predictionResponse);
                  })
    ...
    return (
        <div>
            ...
            <div className="gameContainer">
                ...
                {showModal && (
                    <Modal currentLevel={2} show={showModal}>
              ...
              <LevelGuide key={showModal ? 'faded' : 'visible'} level={2} className={showModal ? 'faded' : ''} />
